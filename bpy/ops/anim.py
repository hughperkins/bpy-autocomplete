...
def channel_view_pick(include_handles=True, use_preview_range=True):
    pass
...
def channels_click(extend=False, extend_range=False, children_only=False):
    pass
...
def channels_view_selected(include_handles=True, use_preview_range=True):
    pass
...
def keyframe_clear_v3d(confirm=True):
    pass


def keyframe_delete(type='DEFAULT'):
    pass
...
def keyframe_delete_by_name(type=""):
    pass


def keyframe_delete_v3d(confirm=True):
    pass


def keyframe_insert(type='DEFAULT'):
    pass
...
def keyframe_insert_by_name(type=""):
    pass


def keyframe_insert_menu(type='DEFAULT', always_prompt=False):
    pass
