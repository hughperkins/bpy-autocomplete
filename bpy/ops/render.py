...
def cycles_performance_preset_add(name="", remove_name=False, remove_active=False):
    pass
...
def cycles_viewport_sampling_preset_add(name="", remove_name=False, remove_active=False):
    pass
